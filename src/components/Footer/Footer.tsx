export default function Footer() {
  return (
    <footer className="mt-68 mx-15 mb-20 sm:mb-40">
      <div className="grid grid-cols-1 gap-10 2xl:grid-cols-2 text-nowrap">
        <div>
          ...
          <h2 className="text-6xl mt-5 md:text-7xl lg:text-8xl">Контаки</h2>
          <div className="flex flex-wrap  gap-10 mt-20 md:flex-nowrap md:gap-50 lg:gap-50">
            <div className="flex flex-col">
              <div>
                ...
                <p className="mt-5 text-xl font-medium select-all">
              ...
              <h4 className="font-semibold text-2xl">Телефони відділів:</h4>
              <div className="flex items-center mt-4">
                <div className="flex items-center gap-3">
                  <img className="h-3" src="Phone.svg" alt="PhoneLogo" />
                  <p className="text-sm font-medium select-all">
                    (044) 444-44-44
                  </p>
                </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex mt-5 gap-1 select-none">
              ...
              <div className="mt-10 sm:mt-36">
                ...
                <p className="text-sm font-medium mt-4 select-all">
                  office@smarto.ua
                </p>
              </div>
            </div>
        ...
        <div className="flex relative -space-x-120 max-2xl:hidden select-none">
          <h2 className="font-regular text-8xl absolute top-15 z-40 left-1">
            Якість
          </h2>
          <img className="object-cover z-30" src="FooterImg-1.png" />
          <img className="object-cover z-20" src="FooterImg-2.png" />
          <h2 className="font-regular text-8xl z-40 absolute right-1 bottom-10 ">
            понад усе
          </h2>
        </div>
      </div>
